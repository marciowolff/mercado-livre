...
describe('clients > commons > http', () => {
  describe('#createClient', () => {
    ...
    it('should create a client with requester lib', () => {
      ...
      expect(fakeRequester.create).toHaveBeenCalledWith({ baseURL: 'base/url' })
    })

    it('should use empty string as default base URL', () => {
      http.createClient(undefined, fakeRequester)
      expect(fakeRequester.create).toHaveBeenCalledWith({ baseURL: '' })
    })
